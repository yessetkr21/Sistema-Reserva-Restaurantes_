    ...
    <div className="min-h-screen bg-black flex items-center justify-center relative overflow-hidden">
      ...
      <div className="bg-white/10 backdrop-blur-lg p-8 rounded-3xl w-96 shadow-2xl border border-white/20 relative z-10">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-black hover:from-purple-700 hover:to-blue-700 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-purple-500/50 shadow-lg hover:shadow-xl mb-6"
          >
        ...
        <p className="text-white/70 text-center mb-4">Don't Have an Account?</p>
        <Link
          to="/register"
          className="block w-full bg-white/10 hover:bg-white/20 text-white font-medium py-3 px-4 rounded-xl transition-all duration-300 border border-white/20 hover:border-white/40 backdrop-blur-sm text-decoration-none text-center"
        >
          Register
        </Link>
